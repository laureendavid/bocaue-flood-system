<section id="page-dashboard" class="page active" aria-labelledby="dashboard-heading">
  ...
  <!-- Evacuation Centers + Announcements (left) | Hotlines (right, extends full height) -->
  <div class="dashboard-evac-row">
    <div class="dashboard-side-stack">
      ...
      <section aria-labelledby="announcements-heading" class="card">
        ...
        <div class="card-scroll" aria-label="Announcements list">
    ...
    <section aria-labelledby="hotlines-heading" class="card dashboard-hotlines-card">
