  ...
  <div class="reg-page">
    <aside class="reg-sidebar">
      ...
      <ul class="sidebar-steps">
        <li class="step-item active"><div class="step-dot">1</div><span class="step-label">Profile</span></li>
        <li class="step-item pending"><div class="step-dot">2</div><span class="step-label">Password</span></li>
    ...
    <main class="reg-main">
      <div class="profile-shell">
        <section class="profile-header fade-up">
          ...
          <p style="margin:0; color:#e5f1ff; font-size:0.92rem;">Complete your profile with an accurate location pin for faster emergency response.</p>
        ...
        <form method="POST" action="register_step1.php" enctype="multipart/form-data" novalidate id="profileForm" class="profile-grid fade-up fade-up-delay-1">
          <div class="upload-column">
            <section class="profile-card">
              ...
              <div class="upload-card-body">
                ...
                <input type="file" id="photo_upload" name="photo_upload" class="profile-file-input" accept=".jpg,.jpeg,.png,image/jpeg,image/png">
            ...
            <section class="profile-card">
              ...
              <div class="upload-card-body">
                ...
                <input type="file" id="valid_id_upload" name="valid_id_image" class="profile-file-input" accept="image/*,application/pdf">
          ...
          <section class="profile-card">
            ...
            <div class="field-row">
              <div class="form-group">
                ...
                <input type="text" id="first_name" name="first_name" class="form-control uppercase-input" required value="<?php echo $sticky['first_name']; ?>">
              </div>
              <div class="form-group">
                <label class="form-label" for="last_name">Last Name</label>
                <input type="text" id="last_name" name="last_name" class="form-control uppercase-input" required value="<?php echo $sticky['last_name']; ?>">
              </div>
            </div>
            <div class="field-row">
              <div class="form-group">
                ...
                <select id="suffix" name="suffix" class="form-control uppercase-input">
                  <option value="" <?php echo ($sticky['suffix'] ?? '') === '' ? 'selected' : ''; ?>>Select suffix (optional)</option>
                  <option value="JR" <?php echo strtoupper($sticky['suffix'] ?? '') === 'JR' ? 'selected' : ''; ?>>JR</option>
                  <option value="SR" <?php echo strtoupper($sticky['suffix'] ?? '') === 'SR' ? 'selected' : ''; ?>>SR</option>
                  <option value="II" <?php echo strtoupper($sticky['suffix'] ?? '') === 'II' ? 'selected' : ''; ?>>II</option>
                  <option value="III" <?php echo strtoupper($sticky['suffix'] ?? '') === 'III' ? 'selected' : ''; ?>>III</option>
                  <option value="IV" <?php echo strtoupper($sticky['suffix'] ?? '') === 'IV' ? 'selected' : ''; ?>>IV</option>
                  <option value="V" <?php echo strtoupper($sticky['suffix'] ?? '') === 'V' ? 'selected' : ''; ?>>V</option>
                </select>
              </div>
              <div class="form-group">
                <label class="form-label">Full Name</label>
                <div class="form-control" id="fullNamePreview" style="display:flex;align-items:center;background:#f3f8fe;">
                  <?php echo htmlspecialchars(trim(($sticky['first_name'] ?? '') . ' ' . ($sticky['last_name'] ?? '') . ' ' . ($sticky['suffix'] ?? ''))); ?>
                </div>
                <p class="hint-text" style="margin-top:0.35rem;">Auto-generated from first name, last name, and suffix.</p>
              </div>
            </div>
            <div class="field-row">
              <div class="form-group">
                <label class="form-label" for="email">Email Address</label>
                <input type="email" id="email" name="email" class="form-control" required value="<?php echo $sticky['email']; ?>">
              </div>
              <div class="form-group">
                <label class="form-label" for="phone">Phone</label>
                <input type="text" id="phone" name="phone" class="form-control" required maxlength="11" placeholder="09XXXXXXXXX" value="<?php echo $sticky['phone']; ?>">
              </div>
            </div>
            <div class="field-row">
              <div class="form-group">
                <label class="form-label" for="date_of_birth">Date of Birth</label>
                <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" required value="<?php echo $sticky['date_of_birth']; ?>">
              </div>
              <div class="form-group">
                <label class="form-label" for="barangay">Barangay</label>
                <select id="barangay" name="barangay" class="form-control" required>
                  <option value="" disabled <?php echo $sticky['barangay'] === '' ? 'selected' : ''; ?>>Select your barangay</option>
          ...
          <section class="profile-card" style="grid-column: 1 / -1;">
            ...
            <div class="field-row" style="margin-top:0.8rem;">
              <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <textarea id="address" name="address" class="form-control form-control--textarea" rows="2" required><?php echo $sticky['address']; ?></textarea>
                <p class="hint-text" style="margin-top:0.45rem;">Auto-filled from map pin. You can manually edit if needed.</p>
              </div>
            </div>
