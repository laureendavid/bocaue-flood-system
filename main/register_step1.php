      ...
      <div class="step1-layout fade-up fade-up-delay-1">
        ...
        <div class="reg-card">
          ...
          <form method="POST" action="register_step1.php" id="step1Form" novalidate>
            ...
            <div class="form-group">
              ...
              <div class="phone-wrap">
                ...
                <input type="tel" id="mobile" name="mobile" class="phone-input" placeholder="9XX XXX XXXX"
                  value="<?php echo $prev_mobile; ?>" maxlength="10" inputmode="numeric" autocomplete="tel-national"
                  required aria-label="Mobile number without country code">
              </div>
              ...
              <div class="otp-group" role="group" aria-labelledby="otp-label">
                ...
                for ($i = 1; $i <= 6; $i++):
                  ...
                  <input type="text" class="otp-box" maxlength="1" inputmode="numeric" pattern="[0-9]"
                    value="<?php echo $digit; ?>" aria-label="OTP digit <?php echo $i; ?>" autocomplete="one-time-code">
                <?php endfor; ?>
              </div>
          ...
          <div style="margin-top:1.25rem; text-align:center;">
            <a href="register_step1.php?resend=1" id="resendLink"
