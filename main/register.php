        ...
        <div class="left-panel">
          ...
          <div class="left-content">
            <svg class="shield-svg" viewBox="0 0 200 230" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M100 10 L180 45 L180 120 C180 170 100 215 100 215 C100 215 20 170 20 120 L20 45 Z" fill="white"
                stroke="#1a3a5c" stroke-width="6" />
              <path d="M35 155 Q55 145 75 155 Q95 165 115 155 Q135 145 165 155" stroke="#1a5276" stroke-width="5"
                fill="none" stroke-linecap="round" />
              <path d="M35 168 Q55 158 75 168 Q95 178 115 168 Q135 158 165 168" stroke="#1a5276" stroke-width="4"
                fill="none" stroke-linecap="round" />
              ...
              <path d="M70 80 L100 55 L130 80" stroke="#dc2626" stroke-width="3" fill="none" stroke-linecap="round"
            ...
            <form id="register-form" method="POST" action="">
              ...
              <div class="form-group">
                <div class="input-wrap">
                  ...
                  <input class="form-input" type="password" name="password" id="reg-password" placeholder="Password"
              ...
              <div class="form-group">
                <div class="select-wrap">
                  ...
                  <select class="form-select" name="barangay" id="barangay" onchange="updateMap()">
                    ...
                    <option value="antipona" <?= (($_POST['barangay'] ?? '') === 'antipona') ? 'selected' : '' ?>>Antipona
                    </option>
                    <option value="bagumbayan" <?= (($_POST['barangay'] ?? '') === 'bagumbayan') ? 'selected' : '' ?>>
                      Bagumbayan</option>
                    <option value="bambang" <?= (($_POST['barangay'] ?? '') === 'bambang') ? 'selected' : '' ?>>Bambang
                    </option>
                    <option value="batia" <?= (($_POST['barangay'] ?? '') === 'batia') ? 'selected' : '' ?>>Batia</option>
                    <option value="binang1" <?= (($_POST['barangay'] ?? '') === 'binang1') ? 'selected' : '' ?>>Biñang 1st
                    </option>
                    <option value="binang2" <?= (($_POST['barangay'] ?? '') === 'binang2') ? 'selected' : '' ?>>Biñang 2nd
                    </option>
                    <option value="bolacan" <?= (($_POST['barangay'] ?? '') === 'bolacan') ? 'selected' : '' ?>>Bolacan
                    </option>
                    <option value="bundukan" <?= (($_POST['barangay'] ?? '') === 'bundukan') ? 'selected' : '' ?>>Bundukan
                    </option>
                    <option value="bunlo" <?= (($_POST['barangay'] ?? '') === 'bunlo') ? 'selected' : '' ?>>Bunlo</option>
                    <option value="caingin" <?= (($_POST['barangay'] ?? '') === 'caingin') ? 'selected' : '' ?>>Caingin
                    </option>
                    ...
                    <option value="lolomboy" <?= (($_POST['barangay'] ?? '') === 'lolomboy') ? 'selected' : '' ?>>Lolomboy
                    </option>
                    <option value="poblacion" <?= (($_POST['barangay'] ?? '') === 'poblacion') ? 'selected' : '' ?>>Poblacion
                    </option>
                    <option value="sulucan" <?= (($_POST['barangay'] ?? '') === 'sulucan') ? 'selected' : '' ?>>Sulucan
                    </option>
                    <option value="taal" <?= (($_POST['barangay'] ?? '') === 'taal') ? 'selected' : '' ?>>Taal</option>
                    <option value="tambobong" <?= (($_POST['barangay'] ?? '') === 'tambobong') ? 'selected' : '' ?>>Tambobong
                    </option>
