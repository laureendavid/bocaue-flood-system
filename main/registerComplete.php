...
<head>
  ...
  <style>
    ...
    .confirm-row:first-of-type { padding-top: 0; }
    .confirm-icon {
    ...
    .confirm-meta { display: flex; flex-direction: column; gap: 0.15rem; min-width: 0; }
    .confirm-label {
      font-size: 0.68rem; font-weight: 700;
      letter-spacing: 0.1em; text-transform: uppercase; color: var(--text-muted);
    }
    .confirm-value { font-size: 0.92rem; font-weight: 600; color: var(--navy); word-break: break-all; }
    .verified-badge {
    ...
    .phone-verified-chip {
      ...
      background: var(--success-bg); border: 1px solid var(--success-border);
      padding: 0.15rem 0.5rem; border-radius: 99px; margin-top: 0.2rem;
    }
    .info-note {
    ...
    .info-note svg { flex-shrink: 0; margin-top: 1px; color: var(--teal-light); }
...
<div class="complete-page">
  ...
  <aside class="reg-sidebar">
    <div class="sidebar-brand">
      ...
      <div><div class="brand-name">Bocaue Flood Information System</div></div>
    </div>
    ...
    <ul class="sidebar-steps">
      <li class="step-item done">
        ...
        <div class="step-meta"><span class="step-label">Verify</span><span class="step-desc">Phone &amp; OTP</span></div>
      </li>
      <li class="step-item done">
        <div class="step-dot">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
        ...
        <div class="step-meta"><span class="step-label">Profile</span><span class="step-desc">Personal details</span></div>
      </li>
      <li class="step-item done">
        <div class="step-dot">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
        ...
        <div class="step-meta"><span class="step-label">Security</span><span class="step-desc">Password set</span></div>
      </li>
      <li class="step-item active">
        ...
        <div class="step-meta"><span class="step-label">Complete</span><span class="step-desc">Account created</span></div>
      </li>
    </ul>
  </aside>
