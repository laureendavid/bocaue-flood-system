    ...
    <div class="reg-card fade-up fade-up-delay-1">
      ...
      >
          ...
          <div class="form-group span-full">
            ...
            <div class="input-wrap">
              ...
              <input type="text" id="full_name" name="full_name" class="form-control"
                     ...
                     value="<?php echo $sticky['full_name']; ?>" required>
            </div>
          </div>
          ...
          <div class="form-group span-full">
            ...
            <div class="input-wrap">
              ...
              <input type="email" id="email" name="email" class="form-control"
                     ...
                     value="<?php echo $sticky['email']; ?>" required
                     autocomplete="email">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrap">
              ...
              <input type="number" id="age_display" name="age_display" class="form-control"
                     value="<?php echo $sticky['age_display']; ?>"
              ...
              <select id="barangay" name="barangay" class="form-control" required>
                ...
                <?php foreach ($barangays as $slug => $info): ?>
                  <option value="<?php echo $slug; ?>"
                    <?php echo ($sticky['barangay'] === $slug) ? 'selected' : ''; ?>>
          ...
          <div class="form-group span-full">
            ...
            <div class="input-wrap">
              ...
              <textarea id="address" name="address" class="form-control form-control--textarea"
                        ...
                        rows="2" required><?php echo $sticky['address']; ?></textarea>
            </div>
          </div>
        ...
        <div class="map-section">
          ...
          <div id="locationStatus" class="location-status" style="display:none;" role="alert" aria-live="polite"></div>
