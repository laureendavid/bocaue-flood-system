    ...
    <main class="reg-main">
      <div class="password-shell">
        <section class="password-header fade-up">
          ...
          <p style="margin:0; color:#e5f1ff; font-size:0.92rem;">Set a strong password for your resident account.
            Username: <strong><?php echo htmlspecialchars($_SESSION['reg_email'] ?? ''); ?></strong></p>
          ...
          <form method="POST" action="register_step2.php" novalidate id="passwordStepForm" class="password-grid">
            <div class="form-group">
              ...
              <ul class="rules-list" id="passwordRules">
                ...
                <li id="rule-underscore"><span class="rule-dot"></span>Contains underscore or valid allowed characters
                </li>
              </ul>
