    ...
    <main class="reg-main">
      <div class="completion-shell">
        <section class="completion-header fade-up">
          ...
          <p style="margin:0; color:#e5f1ff; font-size:0.92rem;">Your profile and password setup are complete. Final
            step: verify your email.</p>
        ...
        <section class="completion-card fade-up fade-up-delay-1">
          ...
          <?php if ($resendMessage !== ''): ?>
            <div class="alert <?php echo $mailStatus === 'sent' ? 'alert-success' : 'alert-danger'; ?>"
              style="max-width:650px;margin:0.9rem auto 0;" role="alert">
